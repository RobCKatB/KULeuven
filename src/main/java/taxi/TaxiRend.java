 ...
 *
 */
public class TaxiRend extends AbstractCanvasRenderer {
  ...
  TaxiRend(RoadModel r, PDPModel p, Language l) {
    lang = l;
    roadModel = r;
    pdpModel = p;
  }
  ...
  public void renderDynamic(GC gc, ViewPort vp, long time) {
    final Set<Tax> taxis = roadModel.getObjectsOfType(Tax.class);
    synchronized (taxis) {
      for (final Tax t : taxis) {
